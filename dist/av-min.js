      ...
      a = function () {
        ...
        return new o(function (t, e) {
          wx.login({
            ...
            fail: function () {
              return e(new Error("wx.login 氓陇卤猫麓楼"))
            }
          })
        })
      };
    t.exports = function (t) {
      t.User = t.Object.extend("_User", {
        ...
        authenticated: function () {
          return console.warn("DEPRECATED: 氓娄鈥毭ε九撁β伱ニ喡っ︹€撀ヂ解€溍モ€奥嵜р€澛λ喡访♀€灻р劉禄氓陆鈥⒚犅睹︹偓聛忙藴炉氓聬娄忙艙鈥懊︹€⑺喢寂捗访ぢ铰棵р€澛� currentUser.isAuthenticated().then()茂录艗氓娄鈥毭ε九撁β伱ニ喡っ︹€撀ッр€澛λ喡访λ溌ヂ惵γλ溌ヂ解€溍モ€奥嵜р劉禄氓陆鈥⒚р€澛λ喡访寂捗访ぢ铰棵р€澛� user.id === currentUser.id茫鈧€�"), !!this._sessionToken && !t._config.disableCurrentUser && t.User.current() && t.User.current().id === this.id
        },
